...
const SignUp: FC = () => {
    ...
    const handleSignUp = async () => {
        ...
        let data = await createAccount(coord, email, password);
                ...
                <Container fluid>
                    <Row>
                        ...
                        <Col style={{ marginBottom: 15 }} xs="12">
                            <Button uppercase={true} buttonColor={theme.colors.tertiary} textColor={theme.colors.onTertiary} style={{ marginBottom: 15 }} mode="contained" onPress={() => handleSignUp()}>
                                Create Account
                            </Button>
                        </Col>
                    </Row>
